...
public class Assessment_frame extends JFrame implements ActionListener,MouseListener,Runnable{
    ...
    JButton b1,b2,b3,b4,b6,b10,b11,b12,b16;
    JTable t1;
    JTextArea tf1,tf3;
    JTextField tf2;
   ...
   JLabel forum=new JLabel(new ImageIcon(loadImage("/Image/conversation (1).png")));
    ...
    public Assessment_frame(String main_user_name, String main_name) throws HeadlessException {
        this.main_user_name = "Admin";
        this.main_name = "SKCET";
...
//        b15=new JButton("Setting");
        ...
        p4.setBounds(270, 265,  700, 480);
        p5.setBounds(270, 265,  700, 480);
//        p6.setBounds(270, 265,  700, 480);
...
//        l9.setFont(new Font("TimesRoman",Font.BOLD,15));
        ...
        jt.addTreeSelectionListener(new TreeSelectionListener() {
            ...
            public void valueChanged(TreeSelectionEvent e) {
                ...
                try {
                    Desktop.getDesktop().open(new java.io.File("C:\\Users\\MAHESH KUMAR B\\Downloads\\documents"+ fileName.get(x-1)));
                } catch (Exception e2) {
